...
public class GiveTypeListHoldView extends BaseViewHolder {
    @BindView(R.id.ordersheet_table_area_item_tv)
    TextView mNameTv;
    ...
    public GiveTypeListHoldView(View view) {
        super(view);
        ButterKnife.bind(this, itemView);
    }

    public void setAreaName(String region_name) {
